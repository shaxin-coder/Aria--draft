...
| TC-API-CAMPAIGN-LIST-HP-002  | L2       | HappyPath       | Retrieve empty campaign list when all campaigns applied      |      |
...
| TC-API-CAMPAIGN-LIST-LOG-003 | L1       | LogicCheck      | Campaign hidden if grant done application                    | 1. applications: user has campaign_id=3, status="Grant Done"                                                                     | 1. Send GET /campaign/list                                                                                    | 1. HTTP 200<br>2. result=0<br>3. campaign id=3 NOT in campaigns                               | Not Run     |      |
